 ...
 *
 * 例如有4堆石子分别为 1 3 5 2，
 * 我们可以先合并1、2堆，代价为4，得到4 5 2， 又合并 1，2堆，代价为9，得到9 2 ，再合并得到11，总代价为4+9+11=24；
...
public class HardA282_MergeStones {
    ...
    public static int getMinWeight() {
        ...
        //  2 如果一次可以合并K堆石子应该怎么半？
        //      看Q1000
        for(int len = 2; len <= n; len++) { // 先两堆两堆的合并，固定窗口大小，从小到大遍历, len=1时不合并（类似归并排序的merge）
